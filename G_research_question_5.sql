...
-- Or, if the GDP increases more significantly in one year, 
-- will this be reflected in food prices or wages in the same or the following year by a more significant increase?

-- answer: It doesn't look like GDP growth has a significant effect on price growth or wage growth or both 
